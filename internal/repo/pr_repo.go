...
type PullRequestRepository interface {
	...
	GetByAuthor(ctx context.Context, authorID string) ([]*entity.PullRequest, error)
...
func NewPullRequestRepo(db *sqlx.DB, c *trm.CtxGetter, trm *manager.Manager) *PullRequestRepo {
...
func (r *PullRequestRepo) Create(ctx context.Context, pr *entity.PullRequest) (string, error) {
...
func (r *PullRequestRepo) GetUserReviews(ctx context.Context, userID string) ([]*entity.PullRequest, error) {
