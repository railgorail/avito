...
type UserRepository interface {
	...
	GetUsersInTeam(ctx context.Context, teamID int) ([]*entity.User, error)
...
func NewUserRepo(db *sqlx.DB, c *trm.CtxGetter) *UserRepo {
	return &UserRepo{
		db:     db,
		getter: c,
	}
...
func (r *UserRepo) Save(ctx context.Context, user *entity.User) (string, error) {
...
func (r *UserRepo) GetUsersInTeam(ctx context.Context, teamName string) ([]*entity.User, error) {
